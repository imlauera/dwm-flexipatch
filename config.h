...
static char selfloatcolor[]              = "#00ff00";
...
static char tagsselbgcolor[]             = "#00ff00";
...
static char urgbordercolor[]             = "#000055";
...
static const Rule rules[] = {
	...
	RULE(.class = "perplexity ai", .tags = 1 << 8)
	RULE(.class = "Perplexity AI", .tags = 1 << 8)
	RULE(.class = "AI Gate", .tags = 1 << 8)
...
static const Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_8,      spawn,          {.v = us_keyboard } },
